...
Create the Rust executable `greentic-desktop-runner` and the CLI integration under `gtc desktop`.
...
[evidence]
store = "~/.greentic/desktop-runner/evidence"
```
